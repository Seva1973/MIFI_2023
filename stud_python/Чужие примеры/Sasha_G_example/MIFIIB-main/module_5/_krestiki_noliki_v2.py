    ...
    while not valid :
        ...
        if 1 <= player_choice <= 9 :
            match player_choice:
                ...
                case 2:
                    selected_cell = grid[0][1]
                case 3 :
                    selected_cell = grid[0][2]
                case 4 :
                    selected_cell = grid[1][0]
                case 5 :
                    selected_cell = grid[1][1]
                case 6 :
                    selected_cell = grid[1][2]
                case 7 :
                    selected_cell = grid[2][0]
                case 8 :
                    selected_cell = grid[2][1]
                case 9 :
                    selected_cell = grid[2][2]
            if selected_cell not in "XO" :
                print(grid[0][1])
                print("cell and turn ", selected_cell, turn)
                selected_cell = f"{Fore.RED}" + turn + f"{Fore.LIGHTYELLOW_EX}"
                valid = True
                switch_turn()
            else :
